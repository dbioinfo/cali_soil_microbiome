...
ggsave("figs/stim_regen/alpha_rarefaction_curve_16S.png", gg)
...
ggsave("figs/stim_regen/alpha_panel_site_16S.png",gg)
...
ggsave("figs/stim_regen/alpha_rarefaction_curve_ITS2.png", gg)
...
ggsave("figs/stim_regen/alpha_panel_site_ITS2.png",gg)
